...
{
    [TestFixture]
    public class SeriesClientFixture
    {
        [Test]
        public void Series_Gets_Find_Request()
        {
        ...
        [Test]
        public async void Series_Gets_Find_Request_Async()
        {
            var client = new FakeRquestClient();
        ...
        [Test]
        public void Series_Gets_Default_FindAll_Request()
        {
            var client = new FakeRquestClient();
        ...
        [Test]
        public async void Series_Gets_Default_FindAll_Request_Async()
        {
            var client = new FakeRquestClient();
        ...
        [Test]
        public void Series_Gets_Parametarized_FindAll_Request()
        {
            var client = new FakeRquestClient();
        ...
        [Test]
        public async void Series_Gets_Parametarized_FindAll_Request_Async()
        {
            var client = new FakeRquestClient();
        ...
        [Test]
        public void Series_Gets_Associated_Characters()
        {
            var client = new FakeRquestClient();
        ...
        [Test]
        public async void Series_Gets_Associated_Characters_Async()
        {
            var client = new FakeRquestClient();
        ...
        [Test]
        public void Series_Gets_Associated_Comics()
        {
            var client = new FakeRquestClient();
        ...
        [Test]
        public async void Series_Gets_Associated_Comics_Async()
        {
            var client = new FakeRquestClient();
        ...
        [Test]
        public void Series_Gets_Associated_Creators()
        {
            var client = new FakeRquestClient();
        ...
        [Test]
        public async void Series_Gets_Associated_Creators_Async()
        {
            var client = new FakeRquestClient();
        ...
        [Test]
        public void Series_Gets_Associated_Events()
        {
            var client = new FakeRquestClient();
        ...
        [Test]
        public async void Series_Gets_Associated_Series_Events_Async()
        {
            var client = new FakeRquestClient();
        ...
        [Test]
        public void Series_Gets_Associated_Stories()
        {
            var client = new FakeRquestClient();
            ...
            marvel.Series.Stories(123, 2, 3, parametrs);

            Assert.AreEqual("series/{id}/stories", client.Request.Resource);
            Assert.AreEqual("Thor", client.Request.Parameters[0].Value);
            Assert.AreEqual("modified", client.Request.Parameters[1].Value);
            Assert.AreEqual("2", client.Request.Parameters[2].Value);
            Assert.AreEqual("3", client.Request.Parameters[3].Value);
        ...
        [Test]
        public async void Series_Gets_Associated_Stories_Async()
        {
            var client = new FakeRquestClient();
            ...
            await marvel.Series.StoriesAsync(123, 2, 3, parametrs);
